	...
	for (let id in data) {
		...
		switch (data[id].precioActual) {
			...
			default:
				...
				precio.innerHTML = '$' + num.toLocaleString("es-AR", { minimumFractionDigits: 2, maximumFractionDigits: 2 });
				if (num < num2) {
					precioAnterior.innerHTML = '$' + num2.toLocaleString("es-Ar", { minimumFractionDigits: 2, maximumFractionDigits: 2 });
					band = true;
				}
		}
